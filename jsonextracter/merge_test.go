...
func BenchmarkJSONPathMerge(b *testing.B) {
	tests := []jsonpathTest{
		...
		// {"name and image", "{.spec.containers[*]['name', 'image']}", podData, "", false},
	}
...
func TestMerge(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "merge name and image", args: args{extracters: []Extracter{containerImageExtracter, containerNameExtracter, kindExtracter, apiVersionExtracter}, input: podData},
